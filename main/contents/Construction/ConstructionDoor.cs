...
namespace main.contents
{
    public partial class ConstructionDoor : Form
    {
        ...
        public ConstructionDoor()
        {
            ...
            //프레임종류 콤보박스
            Program.UTIL.FillComboBox(DB.type.BaseDB_HCneed, Door_comboBox, "커튼월", "프레임재질", "1");
            //설치위치 콤보박스
        ...
        private void OldCW_comboBox_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (item != null)
            {
                OldCW = OldDoor_comboBox.SelectedItem.ToString();
                Calc_Ucw();
                Calc_dUinst();
            }
        }
        ...
        private void Ucw_comboBox_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                UcwMethod = Udoor_comboBox.SelectedItem.ToString();
                Act_UcWMethod();
                Rule_Ucw_g();
            }
        }
        ...
        private void Act_UcWMethod()
        {
            ...
            else if (UcwMethod == "진단")
            {
                ...
                abs_textBox.Enabled = true;
                abs_textBox.BorderStyle = BorderStyle.FixedSingle;
        ...
        {
            if (UcwMethod == "진단" && abs_textBox.Text != string.Empty)
            {
                Ucw_g = Convert.ToDouble(abs_textBox.Text);
            }
            Calc_Ucw();
            Calc_dUinst();
        }
        ...
        {
            if (UcwMethod == "진단" && Panel_checkBox.Checked && Area_textBox.Text != string.Empty)
            {
                Ucw_p = Convert.ToDouble(Area_textBox.Text);
            }
            Calc_Ucw();
            Calc_dUinst();
        }
        ...
        private void PanelCheck()
        {
            if (Panel_checkBox.Checked)
            {
                ...
                Program.UTIL.FillComboBox(DB.type.BaseDB_HCneed, DoorColor_comboBox, "커튼월", "색깔", "1");
            ...
            else
            {
                ...
                DoorColor_comboBox.Visible = false;
        ...
        private void PanelColor_comboBox_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                PanelColor = DoorColor_comboBox.SelectedItem.ToString();
        ...
        public void Rule_Ucw_g()
        {
            if (UcwMethod == "법규")
            {
                ...
                abs_textBox.Text = String.Format("{0:F3}", Ucw_g);
        ...
        public void Rule_Ucw_p()
        {
            if (UcwMethod == "법규")
            {
                ...
                if (Panel_checkBox.Checked)
                {
                    ...
                    Area_textBox.Text = String.Format("{0:F3}", Ucw_p);
                }
                else
                {
                    Ucw_p = 0;
        ...
        private void reset()
        {
            ...
            Door_comboBox.SelectedItem = null;
        ...
        public void LoadData(String ID)            // 리스트에서 항목 더블 클릭시 - 뷰를 ID 의 getValue 값으로 채우기
        {
            ...
            try
            {
                ...
                OldCW = Load[0][3];
                OldDoor_comboBox.SelectedItem = OldCW;
                UcwMethod = Load[0][4];
                Udoor_comboBox.SelectedItem = UcwMethod;
                DiIndi = Load[0][5];
                DiIndi_comboBox.SelectedItem = DiIndi;

                FrameType = Load[0][6];
                Door_comboBox.SelectedItem = FrameType;
            ...
            if (Panel_check == true)
            {
                try
                {
                    ...
                    GlassL_textBox.Text = String.Format("{0:F1}", GlassL_textBox.Text);
            ...
            try
            {
                ...
                DoorType_pictureBox.Visible = true;
                DoorType_pictureBox.Load(Program.gPath + Image1[0][0]);
                DoorType_pictureBox.SizeMode = PictureBoxSizeMode.Zoom;
            }
            catch { }
            try
            {
                ...
                pictureBox4.Visible = true;
                pictureBox4.Load(Program.gPath + Image2[0][0]);
                pictureBox4.SizeMode = PictureBoxSizeMode.StretchImage;
            }
            catch { }
