...
namespace main
{
    internal class DB
    {
        ...
        private Dictionary<string, string> tables = new Dictionary<string, string>()
        {
            ...
            {"User_ABS", "CREATE TABLE IF NOT EXISTS User_ABS (ID INTEGER PRIMARY KEY AUTOINCREMENT,번호 VARCHAR (32),프로젝트유형 VARCHAR (32),DB유형 VARCHAR (32),명칭 VARCHAR (32), 난방냉방 VARCHAR (32),연료 VARCHAR (32),냉방용량 VARCHAR (32),냉방성능 VARCHAR (32),난방용량 VARCHAR (32),난방성능 VARCHAR (32),냉수입구온도 VARCHAR (32),냉수출구온도 VARCHAR (32),온수입구온도 VARCHAR (32),온수출구온도 VARCHAR (32),대기전력 VARCHAR (32),통합성능 VARCHAR (32),대수 VARCHAR (32),설치 VARCHAR (32))"},
            ...
            {"FinalEnergy_Result", "CREATE TABLE IF NOT EXISTS FinalEnergy_Result (ID INTEGER PRIMARY KEY AUTOINCREMENT,프로젝트번호 VARCHAR (32),프로젝트유형 VARCHAR (32),번호 VARCHAR (32),월 VARCHAR (32),연료 VARCHAR (32),난방 VARCHAR (32),냉방 VARCHAR (32),급탕 VARCHAR (32),조명 VARCHAR (32),공조 VARCHAR (32),기저에너지 VARCHAR (32),신재생에너지 VARCHAR (32),총에너지소요량 VARCHAR (32))"},
             //ALT
            {"FinalEnergy_Result_Rule", "CREATE TABLE IF NOT EXISTS FinalEnergy_Result_Rule (ID INTEGER PRIMARY KEY AUTOINCREMENT,프로젝트번호 VARCHAR (32),프로젝트유형 VARCHAR (32),검토유형 VARCHAR (32),번호 VARCHAR (32),월 VARCHAR (32),연료 VARCHAR (32),난방 VARCHAR (32),냉방 VARCHAR (32),급탕 VARCHAR (32),조명 VARCHAR (32),공조 VARCHAR (32),기저에너지 VARCHAR (32),신재생에너지 VARCHAR (32),총에너지소요량 REAL)"},
            {"FinalEnergy_Result_Element", "CREATE TABLE IF NOT EXISTS FinalEnergy_Result_Element (ID INTEGER PRIMARY KEY AUTOINCREMENT,프로젝트번호 VARCHAR (32),프로젝트유형 VARCHAR (32),검토유형 VARCHAR (32),번호 VARCHAR (32),월 VARCHAR (32),연료 VARCHAR (32),난방 VARCHAR (32),냉방 VARCHAR (32),급탕 VARCHAR (32),조명 VARCHAR (32),공조 VARCHAR (32),기저에너지 VARCHAR (32),신재생에너지 VARCHAR (32),총에너지소요량 VARCHAR (32))"},
            {"FinalEnergy_Result_Optimal", "CREATE TABLE IF NOT EXISTS FinalEnergy_Result_Optimal (ID INTEGER PRIMARY KEY AUTOINCREMENT,프로젝트번호 VARCHAR (32),프로젝트유형 VARCHAR (32),검토유형 VARCHAR (32),리모델링안 VARCHAR (32),리모델링값 VARCHAR (32),월 VARCHAR (32),연료 VARCHAR (32),난방 VARCHAR (32),냉방 VARCHAR (32),급탕 VARCHAR (32),조명 VARCHAR (32),공조 VARCHAR (32),기저에너지 VARCHAR (32),신재생에너지 VARCHAR (32),총에너지소요량 VARCHAR (32))"},
