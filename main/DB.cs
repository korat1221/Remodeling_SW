...
namespace main
{
    ...
    internal class DB
    {
        ...
        private Dictionary<string, string> tables = new Dictionary<string, string>()
        {
            ...
            {"Distribution_Form", "CREATE TABLE IF NOT EXISTS Distribution_Form (ID INTEGER PRIMARY KEY AUTOINCREMENT,번호 VARCHAR (32),설비유형 VARCHAR (32),배관유형 VARCHAR (32),배관길이 VARCHAR (32),배관외경 VARCHAR (32),단열재 VARCHAR (32),열전도율 VARCHAR (32),단열두께 VARCHAR (32),선형열관류율 VARCHAR (32))"},
