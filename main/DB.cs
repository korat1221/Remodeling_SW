...
namespace main
{
    ...
    internal class DB
    {
        ...
        private Dictionary<string, string> tables = new Dictionary<string, string>()
        {
            ...
            {"Heating_ce_Form", "CREATE TABLE IF NOT EXISTS Heating_ce_Form (ID INTEGER PRIMARY KEY AUTOINCREMENT,존번호 VARCHAR (32),프로젝트유형 VARCHAR (32),난방시스템 VARCHAR (32),구분 VARCHAR (32),종류 VARCHAR (32),번호 VARCHAR (32),추가유형 VARCHAR (32),가동시간 VARCHAR (32),부하율 VARCHAR (32))"},
