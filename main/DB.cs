    ...
    internal class DB
    {
        ...
        private Dictionary<string, string> tables = new Dictionary<string, string>()
        {
            ...
            {"FinalEnergy_Result", "CREATE TABLE IF NOT EXISTS FinalEnergy_Result (ID INTEGER PRIMARY KEY AUTOINCREMENT,프로젝트번호 VARCHAR (32),프로젝트유형 VARCHAR (32),번호 VARCHAR (32),월 VARCHAR (32),연료 VARCHAR (32),난방 VARCHAR (32),냉방 VARCHAR (32),급탕 VARCHAR (32),조명 VARCHAR (32),공조 VARCHAR (32),기저에너지 VARCHAR (32),신재생에너지 VARCHAR (32),총에너지소요량 VARCHAR (32))"},
             //ALT
            {"FinalEnergy_Result_Rule", "CREATE TABLE IF NOT EXISTS FinalEnergy_Result_Rule (ID INTEGER PRIMARY KEY AUTOINCREMENT,프로젝트번호 VARCHAR (32),프로젝트유형 VARCHAR (32),검토유형 VARCHAR (32),번호 VARCHAR (32),월 VARCHAR (32),연료 VARCHAR (32),난방 VARCHAR (32),냉방 VARCHAR (32),급탕 VARCHAR (32),조명 VARCHAR (32),공조 VARCHAR (32),기저에너지 VARCHAR (32),신재생에너지 VARCHAR (32),총에너지소요량 VARCHAR (32))"},
            ...
            {"FinalEnergy_Result_Optimal", "CREATE TABLE IF NOT EXISTS FinalEnergy_Result_Optimal (ID INTEGER PRIMARY KEY AUTOINCREMENT,프로젝트번호 VARCHAR (32),프로젝트유형 VARCHAR (32),검토유형 VARCHAR (32),리모델링안 VARCHAR (32),월 VARCHAR (32),연료 VARCHAR (32),난방 VARCHAR (32),냉방 VARCHAR (32),급탕 VARCHAR (32),조명 VARCHAR (32),공조 VARCHAR (32),기저에너지 VARCHAR (32),신재생에너지 VARCHAR (32),총에너지소요량 VARCHAR (32))"},
