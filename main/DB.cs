...
namespace main
{
    ...
    internal class DB
    {
        ...
        private Dictionary<string, string> tables = new Dictionary<string, string>()
        {
            ...
            {"User_ce", "CREATE TABLE IF NOT EXISTS User_ce (ID INTEGER PRIMARY KEY AUTOINCREMENT,번호 VARCHAR (32),프로젝트유형 VARCHAR (32),명칭 VARCHAR (32),난방냉방 VARCHAR (32),유형 VARCHAR (32),구분 VARCHAR (32), 종류 VARCHAR (32),용량_냉방 VARCHAR (32),소비전력_냉방 VARCHAR (32),용량_난방 VARCHAR (32),소비전력_난방 VARCHAR (32),온도제어방식 VARCHAR (32),대수 VARCHAR (32),신규기존 VARCHAR (32))"},
            ...
            {"User_DHWHP", "CREATE TABLE IF NOT EXISTS User_DHWHP (ID INTEGER PRIMARY KEY AUTOINCREMENT,번호 VARCHAR (32),프로젝트유형 VARCHAR (32),DB유형 VARCHAR (32),명칭 VARCHAR (32),난방급탕 VARCHAR (32),연료 VARCHAR (32),공급유형 VARCHAR (32),열원 VARCHAR (32),급탕정격용량 VARCHAR (32),급탕정격COP VARCHAR (32),급탕정격소비전력 VARCHAR (32),난방정격용량 VARCHAR (32),난방정격COP VARCHAR (32),난방정격소비전력 VARCHAR (32),한랭지용량 VARCHAR (32),한랭지COP VARCHAR (32),한랭지소비전력 VARCHAR (32),대기전력 VARCHAR (32),대수 VARCHAR (32),설치 VARCHAR (32))"},
            ...
            {"ZoneEnvelope_3D", "CREATE TABLE IF NOT EXISTS ZoneEnvelope_3D (ID INTEGER PRIMARY KEY AUTOINCREMENT,아이디 VARCHAR (32),번호 VARCHAR (32),프로젝트유형 VARCHAR (32),층 VARCHAR (32),존 VARCHAR (32),외피유형 VARCHAR (32),커튼월부위 VARCHAR (32),면적 VARCHAR (32),인접존 VARCHAR (32),방위 VARCHAR (32),방위각 VARCHAR (32),기울기 VARCHAR (32),우측면돌출각도 VARCHAR (32),좌측면돌출각도 VARCHAR (32),상부돌출각도 VARCHAR (32),주변요소음영각도 VARCHAR (32),구조체 VARCHAR (32),구조체번호 VARCHAR (32),우측면돌출길이 VARCHAR (32),좌측면돌출길이 VARCHAR (32),상부돌출길이 VARCHAR (32),주변요소음영길이 VARCHAR (32),벽체길이 VARCHAR (32),창호너비 VARCHAR (32),창호높이 VARCHAR (32),천창유무 VARCHAR (32),차양적용 VARCHAR (32),벽체높이 VARCHAR (32),상인방높이 VARCHAR (32),지면으로부터의상인방높이 VARCHAR (32))"},
            ...
            {"Distribution_Form", "CREATE TABLE IF NOT EXISTS Distribution_Form (ID INTEGER PRIMARY KEY AUTOINCREMENT,번호 VARCHAR (32),설비유형 VARCHAR (32),배관유형 VARCHAR (32),배관길이 VARCHAR (32),배관외경 VARCHAR (32),단열재 VARCHAR (32),열전도율 VARCHAR (32),단열두께 VARCHAR (32),선형열관류율 VARCHAR (32),적용방법 VARCHAR (32),설치위치 VARCHAR (32))"},
            ...
            // ISO 52016 기반 존 요구량 결과.
            {"Zone_52016_Result", "CREATE TABLE IF NOT EXISTS Zone_52016_Result (ID INTEGER PRIMARY KEY AUTOINCREMENT,프로젝트번호 VARCHAR (32),존번호 VARCHAR (32),난방_냉방 VARCHAR (32),월 VARCHAR (32),존이름 VARCHAR (32),순바닥면적 VARCHAR (32),Qb_mth VARCHAR (32),Qb_a VARCHAR (32),Q_max VARCHAR (32),theta_i VARCHAR (32),theta_e VARCHAR (32),dwd_mth VARCHAR (32),Q_DHU_tot VARCHAR (32),HT_tot VARCHAR (32),HT_InWall VARCHAR (32),HT_Slab VARCHAR (32),HT_Wall VARCHAR (32),HT_Roof VARCHAR (32),HT_Floor VARCHAR (32),HT_GWall VARCHAR (32),HT_Door VARCHAR (32),HT_Win VARCHAR (32),HT_CW VARCHAR (32),HT_TB_tot VARCHAR (32),HV_tot VARCHAR (32),HV_inf VARCHAR (32),HV_win VARCHAR (32),HV_z VARCHAR (32),HV_mech VARCHAR (32),H_tot VARCHAR (32),tao VARCHAR (32),nmech VARCHAR (32),nz VARCHAR (32),ninf VARCHAR (32),nwin VARCHAR (32),QTsink_tot VARCHAR (32),QTsink_Wall VARCHAR (32),QTsink_Roof VARCHAR (32),QTsink_Floor VARCHAR (32),QTsink_GWall VARCHAR (32),QTsink_Door VARCHAR (32),QTsink_Win VARCHAR (32),QTsink_CW VARCHAR (32),QTsink_Inwall VARCHAR (32),QTsink_Slab VARCHAR (32),QTsink_TB VARCHAR (32),QVsink_tot VARCHAR (32),QV_inf_sink VARCHAR (32),QV_win_sink VARCHAR (32),QV_z_sink VARCHAR (32),QV_mech_sink VARCHAR (32),QS_rad_tot VARCHAR (32),QS_rad_Wall VARCHAR (32),QS_rad_Roof VARCHAR (32),QS_rad_Door VARCHAR (32),QS_rad_CW_p VARCHAR (32),QS_rad_Win VARCHAR (32),QS_rad_CW VARCHAR (32),QSopsource_tot VARCHAR (32),QSopsource_Wall VARCHAR (32),QSopsource_Roof VARCHAR (32),QSopsource_Door VARCHAR (32),QSopsource_CW_p VARCHAR (32),QStr_tot VARCHAR (32),QStr_own VARCHAR (32),QStr_Win VARCHAR (32),QStr_CW VARCHAR (32),QI_tot VARCHAR (32),QI_own VARCHAR (32),QI_L VARCHAR (32),QI_P VARCHAR (32),QI_fac VARCHAR (32),QI_Humidity VARCHAR (32),Qsink VARCHAR (32),Qsource VARCHAR (32),gamma VARCHAR (32),a VARCHAR (32),eta VARCHAR (32),Q_fan VARCHAR (32))"},
            {"HeatingSystem_Result", "CREATE TABLE IF NOT EXISTS HeatingSystem_Result (ID INTEGER PRIMARY KEY AUTOINCREMENT,프로젝트번호 VARCHAR (32),프로젝트유형 VARCHAR (32), 번호 VARCHAR (32), 월 VARCHAR (32), Qhb_mth_sum VARCHAR (32),  Qh_max_sum VARCHAR (32), Qh_a_sum VARCHAR (32), th_op_day_avg VARCHAR (32),  theta_i_h_set_avg VARCHAR (32), th_avg VARCHAR (32), dop_mth_avg VARCHAR (32),thrL VARCHAR (32),thrL_day VARCHAR (32),dhrB VARCHAR (32),fLNA VARCHAR (32),fLwe VARCHAR (32),beta_h_ce VARCHAR (32),beta_h_d VARCHAR (32),beta_h_s VARCHAR (32),beta_h_gen VARCHAR (32),theta_av_ce VARCHAR (32),theta_av_d VARCHAR (32),theta_av_s VARCHAR (32),theta_av_gen VARCHAR (32),dtheta_ce VARCHAR (32),dtheta_d VARCHAR (32),dtheta_s VARCHAR (32),dtheta_gen VARCHAR (32),dtheta_ce1 VARCHAR (32),dtheta_ce2 VARCHAR (32),Psi_pipe VARCHAR (32),L VARCHAR (32),Qs_po_day VARCHAR (32),Vs VARCHAR (32),Qh_gen_day VARCHAR (32),Pgen_Pn VARCHAR (32),Pgen_Pint VARCHAR (32),Pgen_P0 VARCHAR (32),eta_gen_Pn VARCHAR (32),eta_gen_Pint VARCHAR (32),fpint_Air VARCHAR (32),Qh_outg_sngminus7 VARCHAR (32),Qh_outg_sng2 VARCHAR (32),Qh_outg_sng7 VARCHAR (32),COPminus7 VARCHAR (32),COP2 VARCHAR (32),COP7 VARCHAR (32),Qhb_z VARCHAR (32),Qh_ce_z VARCHAR (32),Qh_d_z VARCHAR (32),Qh_s_z VARCHAR (32),Qh_outg_z VARCHAR (32),Wh_ce_z VARCHAR (32),Wh_d_z VARCHAR (32), Wh_s_z VARCHAR (32),Qhb_ahu VARCHAR (32),Qh_ce_ahu VARCHAR (32),Qh_d_ahu VARCHAR (32),Qh_s_ahu VARCHAR (32),Qh_outg_ahu VARCHAR (32),Wh_ce_ahu VARCHAR (32), Wh_d_ahu VARCHAR (32), Wh_s_ahu VARCHAR (32),Qh_ce VARCHAR (32),Qh_d VARCHAR (32),Qh_s VARCHAR (32),Qh_gen VARCHAR (32),Qh_outg VARCHAR (32),Qh_f VARCHAR (32),Wh_ce VARCHAR (32),Wh_d VARCHAR (32),Wh_s VARCHAR (32),Wh_g VARCHAR (32),Qh_sol VARCHAR (32),연료 VARCHAR (32))"},
            ...
            {"AHUSystem_Result", "CREATE TABLE IF NOT EXISTS AHUSystem_Result (ID INTEGER PRIMARY KEY AUTOINCREMENT,프로젝트번호 VARCHAR (32),프로젝트유형 VARCHAR (32),번호 VARCHAR (32),난방_냉방 VARCHAR (32),월 VARCHAR (32),순공조요구량 VARCHAR (32),공조요구량 VARCHAR (32),공조소요량 VARCHAR (32),가습요구량 VARCHAR (32),급기팬보조에너지 VARCHAR (32),배기팬보조에너지 VARCHAR (32),가습보조에너지 VARCHAR (32),프리히팅보조에너지 VARCHAR (32),제어보조에너지 VARCHAR (32),로터모터보조에너지 VARCHAR (32),theta_vmech VARCHAR (32),Vvmech VARCHAR (32),Vvmech_leak VARCHAR (32),theta_SA_prh VARCHAR (32),theta_OA_du VARCHAR (32),theta_RA_du VARCHAR (32),theta_SA_hr VARCHAR (32),theta_SA_rca VARCHAR (32),theta_SA_du VARCHAR (32),X_iset VARCHAR (32),X_SA_prh VARCHAR (32),X_SA_hr VARCHAR (32),X_SA_rca VARCHAR (32),Vmin_tot VARCHAR (32),Qb_mth_tot VARCHAR (32),Qmax_tot VARCHAR (32),theta_iset_avg VARCHAR (32),dvmech_avg VARCHAR (32),tvmech_avg VARCHAR (32),Q_gnd VARCHAR (32),Q_prh VARCHAR (32),Q_loss_OA_du VARCHAR (32),Q_loss_EA_du VARCHAR (32),Q_loss_SA_du VARCHAR (32),Q_loss_RA_du VARCHAR (32),dtheta_prh VARCHAR (32),dtheta_du_OA VARCHAR (32),dtheta_du_RA VARCHAR (32),dtheta_hr VARCHAR (32),dtheta_rca VARCHAR (32),dtheta_du_EA VARCHAR (32),dtheta_du_SA VARCHAR (32),flea_du VARCHAR (32),flea_ahu VARCHAR (32),fins_ahu VARCHAR (32),theta_defrost VARCHAR (32),theta_sur_nc VARCHAR (32),Hduct_OA VARCHAR (32),Hduct_RA VARCHAR (32),Hduct_EA VARCHAR (32),Hduct_SA VARCHAR (32))"},
