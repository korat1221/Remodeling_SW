...
namespace main
{
    internal class DB
    {
        ...
        private Dictionary<string, string> tables = new Dictionary<string, string>()
        {
            ...
            {"User_PVModule", "CREATE TABLE IF NOT EXISTS User_PVModule (ID INTEGER PRIMARY KEY AUTOINCREMENT, 번호 VARCHAR (32), 프로젝트유형 VARCHAR (32),DB유형 VARCHAR (32),제품명 VARCHAR (32),제조사 VARCHAR (32),CELLTYPE VARCHAR (32),Kpk VARCHAR (32),길이 VARCHAR (32),높이 VARCHAR (32),정격출력 VARCHAR (32),설치 VARCHAR (32))"},
