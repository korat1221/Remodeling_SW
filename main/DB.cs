...
namespace main
{
    ...
    internal class DB
    {
        ...
        private Dictionary<string, string> tables = new Dictionary<string, string>()
        {
            ...
            {"User_ce", "CREATE TABLE IF NOT EXISTS User_ce (ID INTEGER PRIMARY KEY AUTOINCREMENT,번호 VARCHAR (32),프로젝트유형 VARCHAR (32),명칭 VARCHAR (32),난방냉방 VARCHAR (32),구분 VARCHAR (32), 종류 VARCHAR (32),용량_냉방 VARCHAR (32),소비전력_냉방 VARCHAR (32),용량_난방 VARCHAR (32),소비전력_난방 VARCHAR (32),온도제어방식 VARCHAR (32),대수 VARCHAR (32),신규기존 VARCHAR (32))"},
