...
namespace main
{
    internal class DB
    {
        ...
        private Dictionary<string, string> tables = new Dictionary<string, string>()
        {
            ...
            {"AHUSystem_Form", "CREATE TABLE IF NOT EXISTS AHUSystem_Form (ID INTEGER PRIMARY KEY AUTOINCREMENT,번호 VARCHAR (32),프로젝트유형 VARCHAR (32),명칭 VARCHAR (32),존 VARCHAR (32),유형 VARCHAR (32),시스템번호 VARCHAR (32),설치위치 VARCHAR (32),풍량제어 VARCHAR (32),누기시험방법 VARCHAR (32),누기등급1 VARCHAR (32),누기등급2 VARCHAR (32),공조기단열두께 VARCHAR (32),TAB실시유무 VARCHAR (32),OA덕트길이 VARCHAR (32),EA덕트길이 VARCHAR (32),SA덕트길이 VARCHAR (32),RA덕트길이 VARCHAR (32),덕트단열두께 VARCHAR (32),덕트관경 VARCHAR (32),덕트단열재 VARCHAR (32),덕트단열재열전도율 VARCHAR (32),예열예냉유형 VARCHAR (32),프리히터제어유형 VARCHAR (32),프리히터용량 VARCHAR (32),토양유형 VARCHAR (32),지중깊이 VARCHAR (32),쿨튜브관경 VARCHAR (32),쿨튜브두께 VARCHAR (32),쿨튜브길이 VARCHAR (32),쿨튜브재질 VARCHAR (32))"},
            ...
            {"CoolingSystemList", "CREATE TABLE IF NOT EXISTS CoolingSystemList (ID INTEGER PRIMARY KEY AUTOINCREMENT,번호 VARCHAR (32), 명칭 VARCHAR (32), 장비번호 VARCHAR (32), 장비명칭 VARCHAR (32),DB유형 VARCHAR (32), 제어유형 VARCHAR (32), 외기냉방유무 VARCHAR (32), 설치대수 VARCHAR (32), 냉방출력 VARCHAR (32), 냉방전력 VARCHAR (32), EER VARCHAR (32), 대기전력 VARCHAR (32), 연료 VARCHAR (32), 압축기 VARCHAR (32), 부하측형식 VARCHAR (32), 증발기 VARCHAR (32), 냉수입구온도 VARCHAR (32), 냉수출구온도 VARCHAR (32), 설치 VARCHAR (32))"},
            ...
            {"CoolingSystem_Form", "CREATE TABLE IF NOT EXISTS CoolingSystem_Form (ID INTEGER PRIMARY KEY AUTOINCREMENT,번호 VARCHAR (32), 프로젝트유형 VARCHAR (32), 명칭 VARCHAR(32), 설치 VARCHAR(32), 공급존 VARCHAR(32), 공급AHU VARCHAR(32), 냉방설비 VARCHAR(32), 열원설비 VARCHAR(32), 냉방출력 VARCHAR(32), 냉방성능 VARCHAR(32), 제어유형 VARCHAR(32), 연료 VARCHAR(32),외기냉방시스템 VARCHAR(32),대기전력 VARCHAR(32),부하측열원공급설비 VARCHAR(32),냉수출구온도 VARCHAR(32),냉수입구온도 VARCHAR(32),증발기 VARCHAR(32),냉매 VARCHAR(32),부분부하성능 VARCHAR(32),냉각수출구온도 VARCHAR(32),냉각수입구온도 VARCHAR(32), 설치대수 VARCHAR(32), 저장탱크 VARCHAR(32), 저장유형 VARCHAR(32), 펌프유무 VARCHAR (32),펌프방식 VARCHAR (32),펌프1종류 VARCHAR (32),펌프2종류 VARCHAR (32),펌프1밸브 VARCHAR (32),펌프2밸브 VARCHAR (32),펌프1제어 VARCHAR (32),펌프2제어 VARCHAR (32),펌프1대수 VARCHAR (32),펌프2대수 VARCHAR (32),공급설비1종류 VARCHAR (32),공급설비2종류 VARCHAR (32),공급설비3종류 VARCHAR (32),공급설비4종류 VARCHAR (32),압축기종류 VARCHAR (32),ZoneNumber_f VARCHAR (32), QC_a_z VARCHAR (32),QC_max_z VARCHAR (32),A_z VARCHAR (32),AhuNumber_f VARCHAR (32),QC_a_ahu VARCHAR (32),QC_max_ahu VARCHAR (32),A_ahu VARCHAR (32))"},
            //신재생
