    ...
    public partial class CW_FrameDB : Form
    {
        ...
        private void UserDBSpacer_comboBox_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (User_CWSpacer.Length > 0)
            {
                ...
                UserDB_Psimt_textBox.Text = String.Format("{0:F3}", UserDB_Psimt) + " W/m·K";
            }
        ...
        private void Calc_Uf()
        {
            ...
            if (UserDB_Uf > 1.2)
            {
                ...
                UserDB_UfC_textBox.Text = String.Format("{0:F3}", UserDB_Psip) + " W/m·K";
            }
            else
            {
        ...
        private void info_Click(object sender, EventArgs e)
        {
            ...
            string basePath = Program.gPath + "Manual\\2.subcontents\\8.CW\\1.FrameDB";
