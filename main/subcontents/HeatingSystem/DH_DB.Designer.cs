...
namespace main.subcontents.HeatingSystem
{
    partial class DH_DB
    {
        ...
        private void InitializeComponent()
        {
            ...
            GeneralPanel.Controls.Add(infoDHdb);
            ...
            // infoDHdb
            // 
            infoDHdb.BackColor = SystemColors.ControlLight;
            infoDHdb.FlatAppearance.BorderColor = SystemColors.ActiveCaption;
            infoDHdb.FlatStyle = FlatStyle.System;
            infoDHdb.Font = new Font("Microsoft Sans Serif", 9.75F);
            infoDHdb.Location = new Point(765, 11);
            infoDHdb.Margin = new Padding(0);
            infoDHdb.Name = "infoDHdb";
            infoDHdb.Size = new Size(23, 23);
            infoDHdb.TabIndex = 150;
            infoDHdb.Text = "?";
            infoDHdb.UseVisualStyleBackColor = false;
            infoDHdb.Click += infoDHdb_Click;
            // 
            // DH_DB
            // 
