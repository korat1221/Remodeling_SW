...
namespace main.subcontents.HeatingSystem
{
    public partial class Heating_Boiler : Form
    {
        ...
        public Heating_Boiler(String DefaultUse, String SelectBoiler_nonsplit)
        {
        ...
        void load_table_DB()
        {
            ...
            Boiler_dataGridView.Columns[2].Width = 150;
            Boiler_dataGridView.Columns[3].Width = 50;
        ...
        private void infoBoilerdb_Click(object sender, EventArgs e)
        {
            string basePath = Program.gPath + "Manual\\2.subcontents\\12.EquipmentList\\03 Boiler";
