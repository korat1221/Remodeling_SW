...
namespace main.subcontents.ConstructionDoor
{
    public partial class DoorInstall : Form
    {
        double Count_InstallDB;
        String InstallType, InstallLocation;
        string[][] doorInstall;
        int SelectRow;
        public String[] Select_DoorInstall = new string[6];
        String UserNum, UserDBName, UserDBType1, UserDBType2;
        ...
        void load_table_DB()
        {
            ...
            Install_dataGridView.Columns.Add("A2", "제품명");
            Install_dataGridView.Columns.Add("A3", "구분1");//콤보박스
            Install_dataGridView.Columns.Add("A4", "구분2"); //콤보박스
            Install_dataGridView.Columns.Add("A5", "설치선형열관류율.상부.Ψg,top.[W/m·K]");
            Install_dataGridView.Columns.Add("A6", "설치선형열관류율.측면.Ψg,side.[W/m·K]");
            ...
            if(Value.Length > 0)
            {
                for (int n = 0; n < Value.Length; n++)
                {
                    ...
                    for (int k = 0; k < 7; k++)
                    {
                        Install_dataGridView.Rows[nRow].Cells[k + 1].Value = Value[n][k];
                    }
                }
            }
        ...
        {
            if (UserDBName != null && UserDBType2 != null && UserDB_Psi_InstallTop != 0 && UserDB_Psi_InstallSide != 0 && UserDB_Psi_InstallButtom != 0)
            {
        ...
        private void Save_button_Click(object sender, EventArgs e)
        {
            ...
            {
                Select_DoorInstall[i] = row.Cells[i + 2].Value.ToString();
            }
