...
namespace main.subcontents.AHUSystem
{
    public partial class AHU_HRV : Form
    {
        ...
        private void load_table_AHU()
        {
            ...
            HRV_dataGridView.Columns.Add("A4", "설치");
            HRV_dataGridView.Columns.Add("A5", "공조방식");
            HRV_dataGridView.Columns.Add("A6", "열회수.유형");
            HRV_dataGridView.Columns.Add("A7", "열회수.온도교환효율.냉방.[%]");
            HRV_dataGridView.Columns.Add("A8", "열회수.온도교환효율.난방.[%]");
            HRV_dataGridView.Columns.Add("A9", "열회수.유효전열교환효율.냉방.[%]");
            HRV_dataGridView.Columns.Add("A10", "열회수.유효전열교환효율.난방.[%]");
            HRV_dataGridView.Columns.Add("A11", "열회수.습도교환효율.냉방.[%]");
            HRV_dataGridView.Columns.Add("A12", "열회수.습도교환효율.난방.[%]");
            HRV_dataGridView.Columns.Add("A13", "냉각코일.출력.[kW]");
            HRV_dataGridView.Columns.Add("A14", "냉각코일.입구온도.[℃_DB]");
            HRV_dataGridView.Columns.Add("A15", "냉각코일.입구온도.[℃_WB]");
            HRV_dataGridView.Columns.Add("A16", "냉각코일.출구온도.[℃_DB]");
            HRV_dataGridView.Columns.Add("A17", "냉각코일.출구온도.[℃_WB]");
            HRV_dataGridView.Columns.Add("A18", "난방코일.출력.[kW]");
            HRV_dataGridView.Columns.Add("A19", "난방코일.입구온도.[℃_DB]");
            HRV_dataGridView.Columns.Add("A20", "난방코일.출구온도.[℃_DB]");
            HRV_dataGridView.Columns.Add("A21", "가습기.유형");
            HRV_dataGridView.Columns.Add("A22", "가습기.습도수준");
            HRV_dataGridView.Columns.Add("A23", "가습기.용량.[kg/h]");
            HRV_dataGridView.Columns.Add("A24", "송풍기.풍량.급기.[CMH]");
            HRV_dataGridView.Columns.Add("A25", "송풍기.풍량.배기.[CMH]");
            HRV_dataGridView.Columns.Add("A26", "송풍기.정압.급기.[Pa]");
            HRV_dataGridView.Columns.Add("A27", "송풍기.정압.배기.[Pa]");
            HRV_dataGridView.Columns.Add("A28", "송풍기.팬동력.급기.[kW]");
            HRV_dataGridView.Columns.Add("A29", "송풍기.팬동력.배기.[kW]");
            HRV_dataGridView.Columns.Add("A30", "송풍기.모터제어");
            ...
            HRV_dataGridView.Columns[4].Width = 60;
            HRV_dataGridView.Columns[5].Width = 80;
            HRV_dataGridView.Columns[6].Width = 100;
            ...
            HRV_dataGridView.Columns[13].Width = 40;
            HRV_dataGridView.Columns[14].Width = 50;
            HRV_dataGridView.Columns[15].Width = 50;
            HRV_dataGridView.Columns[16].Width = 50;
            HRV_dataGridView.Columns[17].Width = 50;
            HRV_dataGridView.Columns[18].Width = 40;
            HRV_dataGridView.Columns[19].Width = 50;
            HRV_dataGridView.Columns[20].Width = 50;
            HRV_dataGridView.Columns[21].Width = 100;
            HRV_dataGridView.Columns[22].Width = 80;
            ...
            HRV_dataGridView.Columns[29].Width = 40;
            HRV_dataGridView.Columns[30].Width = 100;
