namespace main.subcontents.Alt
{
    partial class AltWall
    {
        ...
        private void InitializeComponent()
        {
            ...
            // SIM_button
            // 
            SIM_button.BackColor = SystemColors.ButtonHighlight;
            SIM_button.ForeColor = Color.Black;
            SIM_button.Location = new Point(462, 10);
            SIM_button.Name = "SIM_button";
            SIM_button.Size = new Size(70, 25);
            SIM_button.TabIndex = 156;
            SIM_button.Text = "SIM";
