...
namespace main.subcontents.CoolingSystem
{
    public partial class Cooling_Top : Form
    {
        ...
        string SystemNum;
        public string SelectCT, SelectCTN;
        public Cooling_Top(string _Num, string _SelectCT_nonsplit, string _SelectCTN_nonsplit)
        {
            InitializeComponent();
            ...
            {
                Load_SaveValue(_SelectCT_nonsplit, _SelectCTN_nonsplit);
            }
        }
        ...
        private void load_table_DB()
        {
            ...
            for (int i = 0; i < DefaultDB_Value.Length; i++)
            {
                ...
                CoolerTop_dataGridView.Rows[nRow].Cells[2].Value = DefaultDB_Value[i][0];//번호
        ...
        private void TableMake()
        {
            ...
            CoolerTop_dataGridView.Columns.Add("A2", "번호");
            CoolerTop_dataGridView.Columns.Add("A3", "명칭");
            CoolerTop_dataGridView.Columns.Add("A4", "형식");
            CoolerTop_dataGridView.Columns.Add("A5", "성능.냉각능력[kW]");
            ...
            CoolerTop_dataGridView.Columns[0].Width = 40;
            CoolerTop_dataGridView.Columns[1].Width = 50;
            CoolerTop_dataGridView.Columns[2].Width = 50;
            CoolerTop_dataGridView.Columns[3].Width = 60;
            CoolerTop_dataGridView.Columns[4].Width = 90;
            CoolerTop_dataGridView.Columns[5].Width = 80;
            CoolerTop_dataGridView.Columns[6].Width = 90;
        ...
        private void Save_button_Click(object sender, EventArgs e)
        {
            ...
            for (int k = 0; k < SelectRow.Count; k++)
            {
                ...
                {
                    this.SelectCTN += CoolerTop_dataGridView.Rows[Convert.ToInt32(SelectRow[k])].Cells[1].Value.ToString();
        ...
        private void reset()
        {
            ...
            for (int n = 0; n < CoolerTop_dataGridView.Rows.Count; n++)
            {
                ...
                CoolerTop_dataGridView.Rows[n].Cells[1].Value = null;
            }
        }

        private void Load_SaveValue(string _SelectCT_nonsplit, string _SelectCTN_nonsplit)
        {
            reset();
            ...
            for (int k = 0; k < SelectCT_split.Count; k++)
            {
                for (int n = 0; n < CoolerTop_dataGridView.Rows.Count; n++)
                {
                    if (CoolerTop_dataGridView.Rows[n].Cells[2].Value.ToString() == SelectCT_split[k].ToString())
                    {
