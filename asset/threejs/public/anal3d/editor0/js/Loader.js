				...
				reader.addEventListener( 'load', async function ( event ) {
					...
					object.traverse( function( child ) {            
						if ( child instanceof THREE.Mesh ) {                 
							...
							editor.collectWalls(offset, child.geometry.getAttribute("position"), child.geometry.getAttribute("normal"), child.geometry.groups);   
						}
					});  
					object.traverse( function( child ) {            
						if (child instanceof THREE.LineSegments) {
							editor.collectWindows(offset, child.geometry.getAttribute("position"));   
						}
					});  
					editor.buildWalls();
					editor.shrinkRooms();
