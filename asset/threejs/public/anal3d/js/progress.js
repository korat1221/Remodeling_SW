...
function initProgress()
{
    jQuery( "#dlgProgress" ).dialog({
        ...
        open: function(event, ui) {
            ...
            jQuery(this)[0].innerHTML = '<table style="border:0;width:100%"><tr><td style="border:0"><span id="progress-msg"></span></td><td align=right style="width:20%;border:0"><img src="/apps/img/waiting.gif" height=32 border=0></td></tr></table>';
        }        
    });
}
