        ...
        public override void AddTabBorder(GraphicsPath path, Rectangle tabBounds)
		{
			switch (_TabControl.Alignment)
			{
				case TabAlignment.Top:
					...
					path.AddLine(tabBounds.X, tabBounds.Y, tabBounds.Right - 12, tabBounds.Y);
                    path.AddLine(tabBounds.Right - 12, tabBounds.Y, tabBounds.Right, tabBounds.Y + 12);
                    path.AddLine(tabBounds.Right, tabBounds.Y + 12, tabBounds.Right, tabBounds.Bottom);
                    break;
